...
| Clean architecture | Domain boundaries, protocols, dependency direction | Chapters 4 and 12 | High |
| Run/support strategies | Observability, safe deploys, incident reasoning | Chapters 5 and 12 | High |
| Work with traders/quants | Requirement discovery and explainable trade-offs | Behavioral pack | High |
| CI/CD and DevOps | Test pyramid, artifact promotion, rollback, controls | Chapter 12 | Medium-high |
...
The role is quantitative development, not a pure quant-research role. Learn enough
